...
public class SrvSummaryFutureEitherOldFashionImpl implements SrvSummaryFutureEither<Error> {
	...
	public SrvSummaryFutureEitherOldFashionImpl(ServiceBookFutEither<Error> srvBook,
